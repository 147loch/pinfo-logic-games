...
export const Sudoku = () => {
  ...
  const findPositionWithFewestPossibilities = () => {
  ...
  this.printPuzzle = () => print.call(this, puzzle);

  this.getPuzzleString = () => sudokuToString.call(this, puzzle);

  this.printSolution = () => print.call(this, solution);

  this.getSolutionString = () => sudokuToString.call(this, solution);
  ...
  this.generatePuzzle = () => this.generatePuzzleSymmetry(Sudoku.Symmetry.NONE);
  ...
  this.getHiddenPairCount = () =>
    getLogCount.call(this, solveInstructions, Sudoku.LogType.HIDDEN_PAIR_ROW) +
    getLogCount.call(
      this,
      solveInstructions,
      Sudoku.LogType.HIDDEN_PAIR_COLUMN
  ...
  this.getPointingPairTripleCount = () =>
    getLogCount.call(
      this,
      solveInstructions,
      Sudoku.LogType.POINTING_PAIR_TRIPLE_ROW
  ...
  this.getGuessCount = () =>
    getLogCount.call(this, solveInstructions, Sudoku.LogType.GUESS);
  this.getBacktrackCount = () =>
    getLogCount.call(this, solveHistory, Sudoku.LogType.ROLLBACK);
  this.getSolveInstructions = () =>
    this.isSolved()
      ? solveInstructions
      : 'No solve instructions - Puzzle is not possible to solve.';
  this.getSolveInstructionsString = () =>
    this.isSolved()
      ? getHistoryString.call(this, solveInstructions)
      : 'No solve instructions - Puzzle is not possible to solve.';

  this.printSolveInstructions = () => {
